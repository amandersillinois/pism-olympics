...
#for GRID  in 1000; do
    for dir in 220; do
        ...
        ncap2 -O -s 'defdim("time",1);time[$time]=.5;time@long_name="Time";time@units="yr"; air_temp_mean_annual[$time,$y,$x]=9.5f; air_temp_mean_july[$time,$y,$x]=15.5f; air_temp_mean_summer[$time,$y,$x]=15.5f; usurf[$time,$y,$x]=0.f;' $outfile $outfile
