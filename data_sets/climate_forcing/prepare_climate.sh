...
for GRID  in 100 200 250 500 1000; do
    ...
    python ~/base/flowline-glacier-model/linear_orog_precip.py -i ../bed_dem/pism_Olympics_${GRID}m_v1.nc -o $outfile --tau_c 933 --tau_f 933 --vapor_scale_height 3200 --wind_direction 249.1 --wind_magnitude 22.1 --background_precip 10 --no_trunc --precip_scale_factor 0.04
