...
for GRID  in 50 100 200 250 500 1000; do
    for dir in 270 250 230; do
        outfile=ltop_climate_olympics_${GRID}m_dir_${dir}_kg_m-2_yr-1.nc
        python ../../scripts/linear_orog_precip.py -i ../bed_dem/pism_Olympics_${GRID}m_v1.nc --background_precip_pre 1 --background_precip_post 0.114 --precip_scale_factor 0.18 --tau_c 2000 --tau_f 2000 --wind_direction $dir --wind_magnitude 8 --moist_stability 0.005 --vapor_scale_height 2600 -o $outfile --o_units 'kg m-2 yr-1' --water_mass_rate
        gdalwarp -overwrite -of netCDF -cutline ../../shp_files/victoria-cutout.shp $outfile tmp_${GRID}m_dir_${dir}_kg_m-2_yr-1.nc
